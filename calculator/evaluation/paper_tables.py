...
# Fix platelets for reporting in tables
data_pre['PLATELETS'] = data_pre['PLATELETS']/1e3
data_post['PLATELETS'] = data_post['PLATELETS']/1e3
data_pre['LEUCOCYTES'] = data_pre['LEUCOCYTES']/1e3
data_post['LEUCOCYTES'] = data_post['LEUCOCYTES']/1e3
data_pre['LYMPHOCYTES'] = data_pre['LYMPHOCYTES']/1e3
data_post['LYMPHOCYTES'] = data_post['LYMPHOCYTES']/1e3
...
col_order = ['Patient Count', 'AGE','GENDER_MALE', 
              ...
              'MAXTEMPERATURE_ADMISSION', 'CREATININE', 'SODIUM','HEMOGLOBIN', 'LEUCOCYTES', 'LYMPHOCYTES', 'PLATELETS',
...
col_mapping = {'ACEI_ARBS': 'ACE Inhibitors or ARBs',
     ...
     'LDL_B':'Elevated LDH',
     'LEUCOCYTES':'Leukocytes (1e3/muL)',
     'LIVER_DISEASE':'Liver Disease',
     'LYMPHOCYTES':'Lymphocytes (1e3/muL)',
     'MAXTEMPERATURE_ADMISSION':'Temperature',
     'OBESITY':'Obesity',
     # 'PCR_B':'Elevated C-Reactive Protein (>10 mg/L)',
     'PCR_B':'Elevated CRP',
     'PLATELETS':'Platelets (1e3/muL)',
     ...
     'TRANSAMINASES_B':'Elevated Transaminases',
     'VIH':'HIV',
     'HF':'Heart Failure',
