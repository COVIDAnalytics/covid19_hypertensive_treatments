...
def get_dataset(model_type, model_lab, columns, imputer, impute = False, 
                path_cremona = '../data/cremona/', path_hm = '../data/spain/',
...
def pairwise_compare(data, data_a, data_b, features, title_mapping = None,
...
X, y = get_dataset_preload(model_type, model_lab, columns, imputer, impute = False)
...
summary_table = pairwise_compare(data, data_a, data_b, features, title_mapping = title_mapping,
