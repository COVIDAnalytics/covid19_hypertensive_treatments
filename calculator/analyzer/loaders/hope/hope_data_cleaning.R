...
data <- data %>%
       mutate(ARTERIALBLOODGASPH = replace(ARTERIALBLOODGASPH, ARTERIALBLOODGASPH=="yes", NA),
              ARTERIALBLOODGASPH = replace(ARTERIALBLOODGASPH, ARTERIALBLOODGASPH=="no", NA),
              ARTERIALBLOODGASPH = as.numeric(ARTERIALBLOODGASPH))
