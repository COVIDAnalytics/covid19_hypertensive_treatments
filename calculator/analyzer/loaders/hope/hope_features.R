...
df <- read.csv("~/Dropbox (Personal)/COVID_clinical/covid19_hope/hope_data.csv", header=TRUE)
...
VITALS_NEW = c('FAST_BREATHING','MAXTEMPERATURE_ADMISSION','02SAT_BELOW92')
...
PROCEDURES_new = c('02DURINGADMISSION', 'HIGHFLOWNASALCANNULA',
...
write.csv(data, "~/Dropbox (Personal)/COVID_clinical/covid19_hope/hope_data_clean.csv")
