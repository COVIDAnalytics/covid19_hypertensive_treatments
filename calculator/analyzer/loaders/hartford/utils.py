...
RENAMED_LAB_MEASUREMENTS = {'x':'Total Bilirubin',
                            ...
                            'SODIUM':'Blood Sodium',
                            'x':'CBC: Lymphocytes',
                            'x':'Prothrombin Time (INR)',
                            'POTASSIUM':'Potassium Blood Level',
                            'x':'Cholinesterase',
                            'x':'ABG: Oxygen Saturation (SaO2)a',
                            'x':'ABG: Oxygen Saturation (SaO2)b',
                            # 'x':'CBC: Red cell Distribution Width (RDW) '
                            'x':'CBC: Platelets',
                            ...
                            'x':'ABG: standard bicarbonate (sHCO3)',
                            'PH':'ABG: pH',
                            'PAO2':'ABG: PaO2',
                            'PACO2':'ABG: PaCO2',
                            # 'x':'ABG: MetHb',
