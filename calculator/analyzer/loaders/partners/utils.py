...
COLS_TREATMENTS = ['HOSPITAL', 'COUNTRY', 'DT_HOSPITAL_ADMISSION', 'GENDER',
                    'RACE', 'AGE', 'DIABETES', 'HYPERTENSION',
                    'DISLIPIDEMIA', 'OBESITY', 'RENALINSUF',
                    'ANYLUNGDISEASE', 'AF', 
                    # 'VIH', 'MAINHEARTDISEASE', 'SMOKING', 'PREGNANT'
                    'ANYHEARTDISEASE',
                    'ANYCEREBROVASCULARDISEASE', 'CONECTIVEDISEASE',
                    'LIVER_DISEASE', 'CANCER', 
                    # 'HOME_OXIGEN_THERAPY', 'IN_PREVIOUSASPIRIN',
                    ...
                    # 'IN_BENZODIACEPINES', 'IN_ANTIDEPRESSANT', 
                    'MAXTEMPERATURE_ADMISSION','FAST_BREATHING', 
                    ...
                    'HEMOGLOBIN', 'PLATELETS',
                     # 'GLASGOW_COMA_SCORE', 'CHESTXRAY_BNORMALITY','ONSET_DATE_DIFF', 'TEST_DATE_DIFF',
                    'CORTICOSTEROIDS', 'INTERFERONOR', 'TOCILIZUMAB', 'ANTIBIOTICS','ACEI_ARBS',
                    'CLOROQUINE', 'ANTIVIRAL','ANTICOAGULANTS',
                    'REGIMEN', 'DEATH', 'COMORB_DEATH']

MORBIDITIES = ['SEPSIS', 'ARF', 'HF', 'EMBOLIC']
...
PARTNERS_LABS = {'HGB': 'HEMOGLOBIN', 
                ...
                'ARTERIAL OXYGEN SAT':'ABG: Oxygen Saturation (SaO2)'}
...
MORBIDITIES = ['ARF','EMBOLIC','HF','SEPSIS','OUTCOME_VENT']
# HOPE TREATMENTS
