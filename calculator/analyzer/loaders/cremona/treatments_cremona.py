...
cremona_treatments.loc[:, 'OUTCOME_VENT'] = 0
for j in patients:
    cremona_treatments.loc[cremona_treatments['NOSOLOGICO'] == j, 'OUTCOME_VENT'] = discharge_info.loc[discharge_info['NOSOLOGICO'] == j, 'Ventilation'].values
