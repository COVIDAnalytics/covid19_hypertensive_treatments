...
BEST_PARAMS_AND_SEEDS = {'mortality_with_lab': {'xgboost': {'best_seed': best_seed, 
                                                        'best_params': {'n_estimators': 689,
                                                                        'learning_rate': 0.037776,
                                                                        'max_depth': 7,
                                                                        'min_child_weight': 0.859562,
                                                                        'gamma': 4.597706,
                                                                        'colsample_bytree': 0.120994,
                                                                        'lambda': 0.289099, 
                                                                        'alpha': 0.296434}},
                        ...
                        'mortality_without_lab': {'xgboost': {'best_seed': best_seed, 
                                                        'best_params': {'n_estimators': 395,
                                                                        'learning_rate': 0.216231,
                                                                        'max_depth': 8,
                                                                        'min_child_weight': 0.814393,
                                                                        'gamma': 3.308258,
                                                                        'colsample_bytree': 0.882236,
                                                                        'lambda': 4.235533, 
                                                                        'alpha': 0.422064}},
