...
BEST_PARAMS_AND_SEEDS = {'mortality_with_lab': {'xgboost': {'best_seed': best_seed, 
                                                        'best_params': {'n_estimators': 555,
                                                                        'learning_rate': 0.218100,
                                                                        'max_depth': 4,
                                                                        'min_child_weight': 0.066037,
                                                                        'gamma': 3.736710,
                                                                        'colsample_bytree': 0.293002,
                                                                        'lambda': 3.134348,
                                                                        'alpha': 3.365429}},
                        ...
                        'mortality_without_lab': {'xgboost': {'best_seed': best_seed, 
                                                        'best_params': {'n_estimators': 524,
                                                                        'learning_rate': 0.307393,
                                                                        'max_depth': 4,
                                                                        'min_child_weight': 0.914216,
                                                                        'gamma': 4.825653,
                                                                        'colsample_bytree': 0.484133,
                                                                        'lambda': 2.075920,
                                                                        'alpha': 1.829968}},
                                                'cart': {'best_seed': best_seed, 
